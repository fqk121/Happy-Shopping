...
const userAddresses = [
  {
    id: '1585486792537149441',
    receiver: '泛泛之人',
    contact: '123456789',
    fullLocation: '浙江省杭州市钱塘区',
    address: '浙江山河大学',
    cityCode: '330101',
    postalCode: '310000',
    provinceCode: '330000',
  ...
  {
    id: '1585486792537149448',
    receiver: '派大星',
    contact: '987654321',
    fullLocation: '河南省焦作市修武县',
    address: '焦作交通大学',
    cityCode: '410800',
    postalCode: '454000',
    provinceCode: '410000',
  ...
  {
    id: '1585486792537149440',
    receiver: '卖火柴的小女孩',
    contact: '147258369',
    fullLocation: '浙江省杭州市西湖区',
    address: '中国西湖文化研究院',
    cityCode: '330101',
    postalCode: '310000',
    provinceCode: '330000',
...
const getCheckInfo = async () => {
  ...
  // const item = userAddresses.find((item) => item.isDefault === 0)
  const item = userAddresses.find((item) => item.isDefault === 0)
        ...
        <div class="box-body">
          <div class="address">
            <div class="text">
              ...
              <ul v-else>
                <li>
                  <span>收<i />货<i />人：</span>{{ curAddress.contact }}
                </li>
